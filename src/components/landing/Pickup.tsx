  ...
  return (
    <Section
      ...
      intro={
        <>
          <p>
            Некоторые работы грязные, шумные или требуют нормального доступа к
            деталям. В таких случаях мебель удобнее забрать, спокойно
            отремонтировать и вернуть обратно.
          </p>
          <p className="mt-4">
            Это особенно актуально, если нужно разобрать диван, заменить пружины,
            поролон, механизм или сделать работу, которую неудобно выполнять
            посреди квартиры.
          </p>
        </>
      }
    >
      ...
      <p className="mt-6 text-[13px] text-muted-foreground">
        Забор, доставка, грузчики и выезд в другой город обсуждаются заранее и
        считаются отдельно.
      </p>
    </Section>
  );
