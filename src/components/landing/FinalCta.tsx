      ...
      <div className="mx-auto max-w-4xl px-4 py-20 md:px-8 md:py-28 text-center">
        ...
        <div className="mt-8 flex justify-center">
          ...
          <a
            ...
            className="group inline-flex items-center justify-center gap-2 rounded-xl bg-primary px-7 py-4 text-[16px] font-semibold text-primary-foreground shadow-[0_8px_24px_-8px_oklch(0.5_0.18_255/0.55)] transition-all hover:bg-primary-hover hover:shadow-[0_12px_28px_-8px_oklch(0.5_0.18_255/0.65)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
          >
