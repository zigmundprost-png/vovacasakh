...
export function Header() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-2 px-3 py-2.5 sm:gap-3 sm:px-6 md:px-8">
        <a href="#top" className="flex items-center gap-2 sm:gap-2.5 min-w-0">
          <BrandMark className="h-9 w-9 shrink-0 text-[12px]" />
          <span className="font-display text-[14px] font-extrabold tracking-tight text-foreground uppercase whitespace-nowrap sm:text-[17px]">
            ВОВА КАРЛО
          </span>
        </a>
