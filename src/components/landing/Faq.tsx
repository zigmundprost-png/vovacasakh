...
const QUESTIONS = [
  ...
  },
  {
    ...
    a: "Да, если ремонт неудобно делать дома. Забор, возврат, грузчиков и выезд за город обсуждаем заранее.",
  },
  {
  ...
  {
    q: "Есть ли гарантия?",
    a: "Да, до 1 года на выполненную работу при нормальной эксплуатации.",
  },
  {
