...
const QUESTIONS = [
  ...
  {
    q: "Есть ли гарантия?",
    a: "На выполненный ремонт — гарантия до 1 года при нормальной эксплуатации мебели. Точные условия зависят от вида работы.",
  },
  {
    q: "Вы делаете сборку мебели?",
    a: "Да, если задача адекватна по объёму. Под крупную сборку подключаю проверенных людей.",
  },
  {
