...
const QUESTIONS = [
  ...
  },
  {
    ...
    a: "Лучше видео. Покажите мебель целиком, место поломки и как проблема проявляется: скрип, провал, механизм, перекос, шатающаяся часть.",
  },
  {
    q: "Вы сами забираете мебель?",
    a: "Если ремонт удобнее делать не дома, забор и возврат можно организовать по договорённости. Логистика считается отдельно.",
  },
  {
    q: "Сколько стоит выезд?",
    a: "Выезд / диагностика по Южно-Сахалинску — 700 ₽. Для других городов условия лучше уточнять заранее.",
  },
  {
    q: "Есть ли гарантия?",
  ...
  },
  {
    ...
    a: "Да, но сборка не главный фокус сайта. Владимир берёт адекватные по объёму задачи и может подключить проверенных людей под крупную сборку.",
  },
  {
    q: "Когда ремонтировать не стоит?",
    a: "Если ремонт технически сомнителен или обойдётся неразумно дорого по сравнению с результатом, Владимир скажет об этом до начала работы.",
  },
];
