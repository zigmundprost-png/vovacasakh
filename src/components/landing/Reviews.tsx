...
const REVIEWS: Review[] = [
  ...
  },
  {
    ...
    text: "Если нужно быстро и качественно отреставрировать мебель, то вам сюда! Нужно было отреставрировать 6 стульев из массива. Позвонила мастеру — сам забрал, всё сделал и привёз. Результат отличный.",
  },
];
...
export function Reviews() {
  return (
    <Section
      ...
      title="Что говорят те, кто уже обращался"
      intro={
        <p>
          Реальные отзывы с площадок объявлений. Без правок и без «нарисованных» имён.
        </p>
      }
    >
