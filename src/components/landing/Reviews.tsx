...
const GROUPS = [
  {
    ...
    text: "Клиенту не пришлось самому решать логистику: машину, грузчиков, время.",
  },
  {
    icon: Sparkles,
    title: "Быстро и аккуратно",
    text: "Сроки, чистота, отсутствие лишней грязи и спокойный процесс.",
  },
  {
    icon: Sofa,
...
export function Reviews() {
  return (
    <Section
      ...
      intro={
        <p>
          В отзывах чаще всего повторяются одни и те же вещи: быстро, аккуратно, сам
          приехал, забрал, сделал, привёз обратно, прислал отчёт, объяснил
          по-человечески.
        </p>
      }
    >
      ...
      <p className="mt-6 text-[13px] text-muted-foreground">
        Перед запуском сюда добавим реальные скриншоты отзывов.
      </p>
    </Section>
  );
}
