          ...
          <div className="max-w-xl">
            ...
            <div className="mt-9 flex flex-col gap-4 sm:flex-row sm:items-center">
              ...
              <a
                ...
                className="group inline-flex items-center justify-center gap-2 rounded-xl bg-primary px-7 py-4 text-[16px] font-semibold text-primary-foreground shadow-[0_8px_24px_-8px_oklch(0.665_0.155_47/0.55)] transition-all hover:bg-primary-hover hover:shadow-[0_12px_28px_-8px_oklch(0.665_0.155_47/0.65)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
              >
