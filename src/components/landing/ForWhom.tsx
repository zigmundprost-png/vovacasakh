...
const FIT = [
  ...
  "Мебель нормальная, и её жалко выбрасывать.",
  "Хотите сначала понять, есть ли смысл ремонтировать.",
  "Важно, чтобы мастер объяснил всё простым языком.",
  "Не хотите сами заниматься перевозкой, если мебель нужно забрать.",
...
const NOT_FIT = [
  ...
  "Нужна бесплатная консультация без материалов.",
