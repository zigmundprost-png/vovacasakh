        ...
        <div className="mt-9 grid gap-8 md:mt-12 md:grid-cols-[260px_1fr] md:gap-10 lg:grid-cols-[300px_1fr] lg:gap-14">
          ...
          <div className="space-y-4 text-[16px] leading-[1.6] text-muted-foreground">
            <p>
              ...
              диваны, кресла, стулья, кровати и другую мягкую мебель. Если
              ремонт неудобно делать дома — могу забрать мебель к себе и
              привезти обратно.
            </p>
            <p>
              Сначала смотрю поломку по фото или видео и честно говорю, есть ли
              смысл ремонтировать.
            </p>
          </div>
        </div>
