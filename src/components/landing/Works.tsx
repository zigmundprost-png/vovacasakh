...
const WORKS: Work[] = [
  ...
  { src: work41, title: "Диван с раскладкой и пружинами", desc: "Ремонт раскладного механизма и замена пружин.", category: "Ремонт", tag: "ремонт механизма раскладывания" },
  { src: work43, title: "Диван-книжка, светлый велюр", desc: "Замена пружинного блока и поролона на одной части. Забирал диван к себе.", category: "Ремонт", tag: "замена пружинного блока", price: "28 000 ₽" },
  { src: work44, title: "Диван с тканью «лён»", desc: "Замена обивки и наполнителя сидений и подушек.", category: "Ремонт", tag: "замена поролона" },
