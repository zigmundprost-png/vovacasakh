...
const WORKS: Work[] = [
  { src: work25, title: "Угловой диван, бежевая ткань", desc: "Ремон, замена пружинного блока, поролона, поролоновых лент углового дивана полностью. Диван был привезён из г. Москва, прослужил 1  год, после чего расползся, пришёл в негодность, ткань осталась целой.\nПружинный блок-10 000₽\nПоролон+ленты поролоновые- 15 000₽\nСпец.Клей(Козеиновый) -2000₽\nСкобы мебельные 3 упаковки -1000₽\nСпуск/увоз дивана- подьём/ доставка отремонтированного изделия 5 000₽\nМоя работ-15 000₽\nИтог работы- 48 000₽. Сделал скидку, так как заказчик делал диван полностью все мягкие части.", category: "Ремонт", tag: "замена поролона" },
  ...
  { src: work4, title: "Диван с ящиком для белья", desc: "Ремонт нижней части линейного дивана у заказчицы дома.\nЦена работы-7000₽", category: "Ремонт", tag: "ремонт механизма раскладывания" },
  { src: work5, title: "Диван-аккордеон", desc: "Ремонт креплений подлокотников, увозил к себе.\nЦена- 9 000₽", category: "Ремонт", tag: "усиление каркаса" },
  ...
  { src: work14, title: "Стулья, тёмное дерево", desc: "Ремонт стульев, замена ткани. Заказчицы покупала ткань сама, по моим размерам. Цена работы 18 000₽ сделал за два дня.", category: "Ремонт", tag: "ремонт стула" },
  { src: work39, title: "Светлые стулья с тканью «дамаск»", desc: "Ремонт стульев.\nЦена- 8000₽", category: "Ремонт", tag: "ремонт стула" },
  { src: work42, title: "Стулья с тёмной кожей", desc: "Ремонт, реставрация стула 6500₽", category: "Ремонт", tag: "ремонт стула" },
  ...
  { src: work28, title: "Круглая детская кроватка", desc: "Ремонт востоновление детской кроватки\nЦена 6000₽", category: "Сборка", tag: "сборка кровати" },
  ...
  { src: work10, title: "Каркас кровати, торцы", desc: "Ресторация спинки кровати у заказчика дома.\n Цена- 5000₽", category: "Ремонт", tag: "усиление каркаса" },
  { src: work6, title: "Шкаф-купе с зеркалами", desc: "Ремонт направляющих и сборка дверей.", category: "Сборка", tag: "сборка шкафа" },
  { src: work7, title: "Комод с ящиками", desc: "Ремонт (корпусной мебели) комод- выпадали, не закрывались ящики. Цена ремонта -5000₽", category: "Ремонт", tag: "ремонт шкафа" },
  { src: work32, title: "Угловой шкаф с зеркалом", desc: "Сборка и ремонт дверей углового шкафа.", category: "Сборка", tag: "сборка шкафа" },
  { src: work34, title: "Замена петель на шкафу", desc: "Установка фасада на место вырванных шурупов. Вырвано три петли. 4 000₽", category: "Ремонт", tag: "ремонт шкафа" },
  { src: work36, title: "Скол на фасаде шкафа", desc: "Аккуратная реставрация скола на дверце.", category: "Ремонт", tag: "ремонт шкафа" },
  { src: work37, title: "Платяной шкаф с ящиками", desc: "Ремонт, востоновление шкафа.\nЦена-6000₽", category: "Сборка", tag: "сборка шкафа" },
