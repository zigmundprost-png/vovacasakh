...
const WORKS: Work[] = [
  ...
  { src: work11, title: "Диван-книжка, серая ткань", desc: "Замена поролона и подтяжка обивки.", category: "Перетяжка" },
  ...
  { src: work12, title: "Стулья из дерева, набор", desc: "Замена обивки сидений на новую ткань.", category: "Перетяжка" },
...
const CATEGORIES: ("Все" | Category)[] = ["Все", "Перетяжка", "Ремонт", "Сборка"];
