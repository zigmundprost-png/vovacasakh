...
const WORKS: Work[] = [
  ...
  { src: work29, title: "Диван с пружинным блоком", desc: "Ремонт выкатной части углового дивана на дому у заказчицы. Замена креплений пружинной системы (металлическая змейка) полностью. Вскрывал, аккуратно разъединял детали, менял крепления и приклеивал специальным клеем всё обратно.\n\nСтоимость — 12 000 ₽. Время работы — 3,5–4 часа.", category: "Ремонт", tag: "замена пружинного блока" },
  { src: work31, title: "Диван-клик-кляк", desc: "Ремонт дивана на дому у заказчицы (аппликация). Привёз купленный поролон, идентичный тому, что был на диване. Зачистил, вырезал и вклеил новый наполнитель.\n\nСтоимость работы — 10 000 ₽.", category: "Ремонт", tag: "замена поролона" },
  { src: work33, title: "Диван с порванной обивкой", desc: "Мелкий ремонт ткани на подлокотнике дивана.\n\nСтоимость — 3 500 ₽.", category: "Ремонт", tag: "ремонт подлокотника" },
  { src: work35, title: "Усиление каркаса дивана", desc: "Ремонт выкатной части углового дивана на дому у клиента.\n\nСтоимость — 8 000 ₽.", category: "Ремонт", tag: "усиление каркаса" },
  { src: work38, title: "Угловой диван, белая ткань", desc: "Усиление мебельных строп на двух частях углового дивана на дому у заказчика. Работа с материалом мастера выполнена за два дня.\n\nСтоимость — 20 000 ₽.", category: "Ремонт", tag: "усиление каркаса" },
  { src: work40, title: "Диван-книжка с обновлением", desc: "Ремонт каркаса нижней части линейного дивана. Замена брусков, фанеры, поролона и элементов наполнителя. Чехол постирал.\n\nСтоимость работы с материалом — 35 000 ₽.", category: "Ремонт", tag: "замена поролона" },
  { src: work41, title: "Диван с раскладкой и пружинами", desc: "Ремонт деревянного каркаса, замена деревянных элементов подлокотника. Подлокотник увезли в мастерскую.\n\nСтоимость работы — 7 000 ₽.", category: "Ремонт", tag: "ремонт механизма раскладывания" },
  { src: work43, title: "Диван-книжка, светлый велюр", desc: "Ремонт одной части линейного дивана (книжка). Замена пружинного блока и поролона. Диван забирал в мастерскую.\n\nСтоимость вместе с материалом — 28 000 ₽.", category: "Ремонт", tag: "замена поролона" },
  { src: work44, title: "Диван с тканью «лён»", desc: "Замена поролона и пружинного блока. Диван увозил в мастерскую.\n\nСтоимость:\nПружинный блок и поролон — 10 000 ₽\nСпуск/подъём и доставка — 5 000 ₽\nКлей — 2 000 ₽\nСкобы — 700 ₽\nРабота — 10 000 ₽\nИтого — 28 000 ₽", category: "Ремонт", tag: "замена поролона" },
  ...
  { src: work11, title: "Диван-книжка, серая ткань", desc: "Ремонт двух частей линейного дивана с наполнением подушек.\n\nСтоимость:\nПоролон — 12 000 ₽\nПружинный блок — 8 000 ₽\nНаполнение подушек — 5 000 ₽\nДоставка — 5 000 ₽\nКлей — 2 000 ₽\nСкобы — 1 000 ₽\nРабота — 12 000 ₽\nИтого — 45 000 ₽\nПри заказе на две части дивана с наполнением делаю скидку.", category: "Ремонт", tag: "замена поролона" },
  { src: work4, title: "Диван с ящиком для белья", desc: "Ремонт нижней части линейного дивана на дому у заказчицы.\n\nСтоимость работы — 7 000 ₽.", category: "Ремонт", tag: "ремонт механизма раскладывания" },
  { src: work5, title: "Диван-аккордеон", desc: "Ремонт креплений подлокотников. Подлокотник увезли в мастерскую.\n\nСтоимость — 9 000 ₽.", category: "Ремонт", tag: "усиление каркаса" },
  { src: work16, title: "Диван-кровать с раскладкой", desc: "Ремонт дивана «Аккордеон» на дому у заказчицы. Замена части раздвижного элемента и частичная замена деревянных ламелей. Сломанную запасную часть раскладного элемента клиент покупала сама, ламели приобретал сам.\n\nСтоимость работы — 6 500 ₽.", category: "Ремонт", tag: "ремонт механизма раскладывания" },
  { src: work24, title: "Механизм дивана-книжки", desc: "Замена механизма «книжка» на новый на дому у заказчицы.\n\nСтоимость работы — 7 000 ₽.", category: "Ремонт", tag: "ремонт механизма раскладывания" },
  { src: work9, title: "Гинекологическое кресло", desc: "Ремонт гинекологического кресла.\n\nСтоимость — 15 000 ₽.", category: "Ремонт", tag: "усиление каркаса" },
  ...
  { src: work14, title: "Стулья, тёмное дерево", desc: "Ремонт стульев с заменой ткани. Заказчица покупала ткань сама по моим размерам. Работа выполнена за два дня.\n\nСтоимость — 18 000 ₽.", category: "Ремонт", tag: "ремонт стула" },
  { src: work39, title: "Светлые стулья с тканью «дамаск»", desc: "Ремонт стульев.\n\nСтоимость — 8 000 ₽.", category: "Ремонт", tag: "ремонт стула" },
  { src: work42, title: "Стулья с тёмной кожей", desc: "Ремонт и реставрация стула.\n\nСтоимость — 6 500 ₽.", category: "Ремонт", tag: "ремонт стула" },
  ...
  { src: work28, title: "Круглая детская кроватка", desc: "Ремонт и восстановление детской кроватки.\n\nСтоимость — 6 000 ₽.", category: "Сборка", tag: "сборка кровати" },
  ...
  { src: work10, title: "Каркас кровати, торцы", desc: "Реставрация спинки кровати на дому у заказчика.\n\nСтоимость — 5 000 ₽.", category: "Ремонт", tag: "усиление каркаса" },
  { src: work6, title: "Шкаф-купе с зеркалами", desc: "Ремонт направляющих и сборка дверей.", category: "Сборка", tag: "сборка шкафа" },
  { src: work7, title: "Комод с ящиками", desc: "Ремонт корпусной мебели: комод — выпадали и не закрывались ящики.\n\nСтоимость — 5 000 ₽.", category: "Ремонт", tag: "ремонт шкафа" },
  { src: work32, title: "Угловой шкаф с зеркалом", desc: "Сборка и ремонт дверей углового шкафа.", category: "Сборка", tag: "сборка шкафа" },
  { src: work34, title: "Замена петель на шкафу", desc: "Установка фасада на место вырванных шурупов. Вырвано три петли.\n\nСтоимость — 4 000 ₽.", category: "Ремонт", tag: "ремонт шкафа" },
  { src: work36, title: "Скол на фасаде шкафа", desc: "Аккуратная реставрация скола на дверце.", category: "Ремонт", tag: "ремонт шкафа" },
  { src: work37, title: "Платяной шкаф с ящиками", desc: "Ремонт и восстановление шкафа.\n\nСтоимость — 6 000 ₽.", category: "Сборка", tag: "сборка шкафа" },
