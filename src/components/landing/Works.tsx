...
const WORKS: Work[] = [
  ...
  { src: work26, title: "Диван с разобранным каркасом", desc: "Полная переборка: каркас, ремни и обивка из экокожи.", category: "Ремонт", tag: "усиление каркаса" },
  { src: work27, title: "Модульный диван, серая ткань", desc: "Подтяжка обивки и восстановление формы подушек.", category: "Ремонт", tag: "замена поролона" },
  { src: work29, title: "Диван с пружинным блоком", desc: "Замена змеевидных пружин и наполнителя.", category: "Ремонт", tag: "замена пружинного блока" },
  { src: work31, title: "Диван-клик-кляк", desc: "Замена изношенной обивки и наполнителя на новую ткань.", category: "Ремонт", tag: "замена поролона" },
  { src: work33, title: "Диван с порванной обивкой", desc: "Аккуратный ремонт ткани в месте прорыва.", category: "Ремонт", tag: "ремонт подлокотника" },
  { src: work35, title: "Усиление каркаса дивана", desc: "Ремонт сломанных брусков основания и сборка обратно.", category: "Ремонт", tag: "усиление каркаса" },
  { src: work38, title: "Угловой диван, белая ткань", desc: "Замена ремней основания и восстановление сидений.", category: "Ремонт", tag: "усиление каркаса" },
  { src: work40, title: "Диван-книжка с обновлением", desc: "Замена обивки и наполнителя на новую ткань.", category: "Ремонт", tag: "замена поролона" },
  ...
  { src: work43, title: "Диван-книжка, светлый велюр", desc: "Замена обивки и восстановление формы.", category: "Ремонт", tag: "замена поролона" },
