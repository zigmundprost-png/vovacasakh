  ...
  head: () => ({
    meta: [
      { title: "ВОВА КАРЛО — ремонт диванов в Южно-Сахалинске" },
      {
        name: "description",
        content:
          "Меня зовут Владимир, я частный мастер по ремонту диванов, кресел, стульев и кроватей в Южно-Сахалинске. Посмотрю поломку по фото или видео, при необходимости заберу и привезу мебель. Качество гарантирую.",
      },
